...
<div class="checkout-container">
    ...
    <div id="mainContent" class="checkout-content">
        <div class="checkout-main">
            ...
            <?php echo $__env->make('shops.checkout.step-1-shipping', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Step 2: Shipping Method -->
            <?php echo $__env->make('shops.checkout.step-2-method', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Step 3: Order Details -->
            <?php echo $__env->make('shops.checkout.step-3-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <!-- Step 5: Completed -->
            <?php echo $__env->make('shops.checkout.step-5-completed', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <!-- Right Section - Order Summary -->
        <?php echo $__env->make('shops.checkout.order-summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
...
<!-- PayPal SDK -->
<script src="https://www.paypal.com/sdk/js?client-id=<?php echo e(config('services.paypal.client_id')); ?>&currency=GBP"></script>

<?php echo $__env->make('shops.checkout.checkout-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/solob/dev/tokesi/Tokesi/resources/views/shops/checkout.blade.php ENDPATH**/ ?>