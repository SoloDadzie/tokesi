<div id="step5" class="step-content hidden">
    <div class="text-center py-16 px-5 max-w-2xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row gap-4 justify-center mt-10">
            <a href="<?php echo e(route('home')); ?>" class="btn-hover-effect bg-orange-600 text-white font-semibold py-3 px-8 rounded active:scale-[0.98] transition-transform">
...
</div><?php /**PATH /Users/solob/dev/tokesi/Tokesi/resources/views/shops/checkout/step-5-completed.blade.php ENDPATH**/ ?>