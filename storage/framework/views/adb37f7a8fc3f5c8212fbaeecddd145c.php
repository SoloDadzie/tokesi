<script>
// Configuration
const STRIPE_KEY = '<?php echo e($stripeKey); ?>';
...
async function loadCartSummary() {
    try {
        ...
        if (data.success) {
            ...
            setTimeout(() => window.location.href = '<?php echo e(route("home")); ?>', 2000);
        }
    } catch (error) {
...
<?php /**PATH /Users/solob/dev/tokesi/Tokesi/resources/views/shops/checkout/checkout-script.blade.php ENDPATH**/ ?>