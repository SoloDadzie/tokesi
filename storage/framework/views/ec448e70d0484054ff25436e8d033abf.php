...
<?php $__env->startSection('title', 'Shop Children’s Books by Tokesi Akinola | Buy Kids’ Books Online'); ?>

<?php $__env->startSection('meta_description', 'Buy children’s books by Tokesi Akinola, Shop inspiring kids’ stories crafted to spark creativity and imagination.'); ?>
    ...
    <div class="shop-container">
        ...
        <div class="products-section">
            <div class="products-header">
                <p class="products-count">Showing <?php echo e($products->count()); ?> of <?php echo e($products->total()); ?> books</p>
            </div>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            ...
                            <div class="product-overlay">
                                <a href="<?php echo e(route('product.show', $product->slug)); ?>" class="btn btn-primary">View Details</a>
                            </div>
                        </div>
                        <div class="product-info">
                            <h3 class="product-title"><a href="<?php echo e(route('product.show', $product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                            <p class="product-description"><?php echo e($product->short_description ? \Illuminate\Support\Str::limit(strip_tags($product->short_description), 110) : 'Discover this inspiring story crafted for young readers.'); ?></p>
                            <div class="product-footer">
                                <span class="product-price"><?php echo e($product->getPriceFormatted()); ?></span>
                                <button class="btn btn-outline btn-sm add-to-cart" onclick="addToCart('<?php echo e($product->id); ?>', 1, null, this)">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="product-card">
                        <div class="product-info">
                            ...
                            <div class="product-footer">
                                <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-outline btn-sm">Clear Filters</a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/solob/dev/tokesi/Tokesi/resources/views/shops/index.blade.php ENDPATH**/ ?>